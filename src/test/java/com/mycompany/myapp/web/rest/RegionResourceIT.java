...
import com.mycompany.myapp.JhAdhApp;
 ...
 */
@SpringBootTest(classes = JhAdhApp.class)
public class RegionResourceIT {
    ...
    private static final String DEFAULT_REGION_NAME_2 = "AAAAAAAAAA";
    private static final String UPDATED_REGION_NAME_2 = "BBBBBBBBBB";
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region()
            ...
            .regionName2(DEFAULT_REGION_NAME_2);
        return region;
    }
    /**
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region()
            ...
            .regionName2(UPDATED_REGION_NAME_2);
        return region;
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getRegionName2()).isEqualTo(DEFAULT_REGION_NAME_2);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].regionName2").value(hasItem(DEFAULT_REGION_NAME_2)));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.regionName2").value(DEFAULT_REGION_NAME_2));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getRegionName2()).isEqualTo(UPDATED_REGION_NAME_2);
    }
